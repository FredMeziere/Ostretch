...
function HumanBody() {
  ...
  return (
    <div className="main-body">
      ...
      { isStomachOpen ? (
        <div className="stomach-cards" id="category-cards">
      ...
      { isLegsOpen ? (
        <div className="legs-cards" id="category-cards">
